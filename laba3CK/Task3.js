...
var owner1 = new OwnerClass("Сталин", "Анатолий", "Андреевич", new Date(1990, 1, 1), TypeOfDocument.Passport, "5544", "524520");
var car1 = new CarImpl("Toyota", "Aboba", 2020, "SGSSE234241", "AFF533", owner1, BodyType.Sedan, CarClass.Luxury);
var motorbike1 = new MotorbikeImpl("Lada", "Granata", 2021, "SHKKGHSOI393", "ZZZ000", owner1, "Sport", true);
